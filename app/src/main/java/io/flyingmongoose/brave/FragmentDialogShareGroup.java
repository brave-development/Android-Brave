...
public class FragmentDialogShareGroup extends DialogFragment
{
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        boolean privateGroup = args.getBoolean("privateGroup", false);
        String groupName = args.getString("groupName");
        String groupCode = args.getString("groupCode");

        //Set title
        txtvTitle.setText(getString(R.string.diagShareGroupTitle)  + " " + groupName);

        //Set msg
        String msg = getString(R.string.diagShareGroupMsgPrefix) + " " + groupCode + " " + getString(R.string.diagShareGroupMsgSuffix);
        txtvMsg.setText(msg);

        //String build share msg
        final String shareMsg = HomeActivity.currentUser.get("name") + " " + getString(R.string.diagShareGroupShareMsgPrefix) + " " + groupCode + " " + getString(R.string.diagShareGroupShareMsgSuffix)
         + "\nAndroid: " + getString(R.string.appUrlANDROID) + "\niOS: " + getString(R.string.appUrlIOS);
