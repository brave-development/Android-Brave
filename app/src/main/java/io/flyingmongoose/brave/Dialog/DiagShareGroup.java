...
public class DiagShareGroup extends DialogFragment
{
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        final String shareMsg = ActivHome.currentUser.get("name") + " " + getString(R.string.diagShareGroupShareMsgPrefix) + " " + groupCode + " " + getString(R.string.diagShareGroupShareMsgSuffix)
