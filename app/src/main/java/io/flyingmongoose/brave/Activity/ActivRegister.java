...
public class ActivRegister extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener, TextView.OnEditorActionListener{
    ...
    private final ActivRegister thisActivity = this;
