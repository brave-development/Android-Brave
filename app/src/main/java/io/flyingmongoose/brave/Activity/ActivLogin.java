...
public class ActivLogin extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, TextView.OnEditorActionListener
{
    ...
    private final ActivLogin thisActivity = this;
...
//        }
    ...
    {
        Intent boardingIntent = new Intent(this, ActivOnBoarding.class);
    ...
    private void regWithFacebook(ParseUser parseUser)
    {
        ...
        Intent registerIntent = new Intent(ActivLogin.this, ActivRegister.class);
    ...
    public void login()
    {
        ...
        final Intent intentLogin = new Intent(ActivLogin.this, ActivHome.class);
...
//        startActivityForResult(registerIntent, REQ_CODE_REGISTER_USER);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode == REQ_CODE_REGISTER_USER_FB)
        {
            ...
            {
                Intent homePanicIntent = new Intent(ActivLogin.this, ActivHome.class);
