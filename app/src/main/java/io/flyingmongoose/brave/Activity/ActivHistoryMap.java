...
public class ActivHistoryMap extends AppCompatActivity implements View.OnClickListener
{
    ...
    private final String TAG = "ActivHistoryMap";
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        if(!name.equalsIgnoreCase(ActivHome.currentUser.getString("name")))
        {
