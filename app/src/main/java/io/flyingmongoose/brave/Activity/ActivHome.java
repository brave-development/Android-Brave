...
public class ActivHome extends AppCompatActivity implements AdapterView.OnItemClickListener
{
    private final int REQ_PERM_LOC = 100;
    private final String LOG_TAG = "ActivHome";
    ...
    private AdaptNav adaptNav;      //Custom adapter for populating nav menu
    public static TextView txtvProfileName;
    private View vDummyGroupTut;

    //fragments
    public FragPanic fragPanic = null;
    public  static FragMap fragMap = null;
    public FragGroups fragGroups = null;
    public FragSettings fragSettings = null;
    public FragSettingsNew fragSettingsNew = null;
    ...
    public final String TAG = "ActivHome";
...
//        adaptNav = new AdaptNav(this);
//        lstvNav.setAdapter(adaptNav);
...
//               // Toast.makeText(ActivHome.this, "Drawer Opened", Toast.LENGTH_LONG).show();
//            }
//
//            @Override
//            public void onDrawerClosed(View drawerView) {
//                super.onDrawerClosed(drawerView);
//                //Toast.makeText(ActivHome.this, "Drawer Closed", Toast.LENGTH_LONG).show();
//            }
//        };
                ...
                switch(position)
                {
                    ...
                    case 4:
                        ...
                        if(fragSettingsNew == null)
                            fragSettingsNew = new FragSettingsNew();
...
//        Log.d("debugBottomNav", "Position5X: " + btnMainPos5X);
    ...
    private void initFragments()
    {
        ...
        fragPanic = new FragPanic();
//        fragMap = new FragMap();
//        fragGroups = new FragGroupsOld();
//        fragSettings = new FragSettings();
//        fragHistory = new FragHistory();
//        fragBottomActionBar = new FragBottomActionBar();
//        fragMangGroups = new FragManageGroups();
...
//                .usageId(adaptNav.getGroupView().getId() + "") //UNIQUE ID
//                .dismissOnBackPress(true)
//                .dismissOnTouch(true)
//                .show();
//
//        final ActivHome activity = this;
//
...
//            startActivity(Intent.createChooser(share, "Share Panic"));
            DiagShareApp diagShareApp = new DiagShareApp();
            diagShareApp.show(getSupportFragmentManager(), "diagShareApp");
        }

        if(item.getItemId() == 1)
        {
            DiagFeedback diagFeedback = new DiagFeedback();
...
//        else
    ...
    public void onClickLogout(View view)
    {
        ...
        ParseUser.logOut();
        Intent intentLogout = new Intent(this, ActivLogin.class);
...
//        if(Integer.parseInt(FragGroupsOld.txtvGroupsRemainingValue.getText().toString()) > 0)
//        {
//
...
class AdaptNav extends BaseAdapter
{
    ...
    public AdaptNav(Context context)
    {
