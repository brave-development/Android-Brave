...
public class FragmentDialogShareApp extends DialogFragment
{
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        final String shareMsg = HomeActivity.currentUser.get("name") + " " + getString(R.string.diagShareAppShareMsg) + "\n" + getString(R.string.appSiteUrl);
