...
public class UtilValidate
{
    ...
    public static boolean validatePhone(Activity activity, String inputText, TextInputLayout tillPhone, boolean showErrorMsgs)
    {
        boolean valid = true;
    ...
    public static boolean validateFullName(Activity activity, String inputText, TextInputLayout tillFullName, boolean showErrorMsgs)
    {
        boolean valid = true;
    ...
    public static boolean validateEmail(Activity activity, String inputText, TextInputLayout tillEmail, boolean showErrorMsgs)
    {
        boolean valid = true;
