...
public class FragGroupNew extends Fragment
{
    private ActivHome activity;
    private Context context;
    private final FragGroupNew thisFrag = this;
        ...
        btnFinish.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if(validate())
                {
                    ...
                    //Format group name
                    final String groupNameFlat = UtilFormating.formatGroupFlatName(groupName);
                    final String finalFormattedGroupName = UtilFormating.formatGroupName(groupName);
                    final String channelName = UtilFormating.formatChannelName(groupName);
    ...
    private void initEditGroup(int groupIndex)
    {
        ...
        final FragGroups fragGroups = (FragGroups) ActivHome.fragManager.findFragmentByTag("fragGroups");
                                    ...
                                    if(e == null)
                                    {
                                        ...
                                        group.saveInBackground(new SaveCallback()
                                        {
                                            ...
                                            public void done(ParseException e)
                                            {
                                                ...
                                                {
                                                    srLayNewGroup.setRefreshing(false);
                                                    Snackbar.make(ActivHome.txtvProfileName, "Group Updated", Snackbar.LENGTH_LONG).show();
                                                    ActivHome.fragManager.popBackStack();
                                                } else
                                                {
                                                    //Unsuccessful
    ...
    public void createGroup(final String groupName, String groupNameFlat, String groupDescription, final String channelName, final boolean groupPublic, Uri groupimageUri)
    {
        ...
        newGroup.put("admin", ActivHome.currentUser);
        newGroup.put("country", ActivHome.currentUser.get("country"));
        newGroup.put("subscribers", 1);
        newGroup.add("subscriberObjects", ActivHome.currentUser.getObjectId());
                        ...
                        newGroup.saveInBackground(new SaveCallback()
                        {
                            ...
                            public void done(ParseException e)
                            {
                                if(e == null)
                                {
                                    ...
                                    ActivHome.currentUser.add("groups", newGroup.getString("name"));
...
//        alert.show();
        ...
        DiagShareGroup diagShare = new DiagShareGroup();
