 ...
 */
public class CustomListAdapterGroups extends ArrayAdapter implements Filterable
{
    ...
    public CustomListAdapterGroups(Context context, int layRes, List<ParseObject> items)
    {
